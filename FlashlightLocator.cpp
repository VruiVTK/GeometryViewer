...
FlashlightLocator::FlashlightLocator(Vrui::LocatorTool * locatorTool,
  VruiVTK* VruiVTK) :
  BaseLocator(locatorTool, VruiVTK),
  FlashlightSwitch(0),
  FlashlightPosition(0),
  FlashlightDirection(0)
{
  this->FlashlightSwitch = VruiVTK->getFlashlightSwitch();
  this->FlashlightPosition = VruiVTK->getFlashlightPosition();
  this->FlashlightDirection = VruiVTK->getFlashlightDirection();
